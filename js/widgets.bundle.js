    ...
    init: function () {
        ! function () {
            ...
            if (e) {
                ...
                i(KTUtil.getCssVariableValue("--kt-primary"), t.lineWidth, 100 / 100), i(KTUtil.getCssVariableValue("--kt-success"), t.lineWidth, 34/100)
            }
        }()
    }
};
...
var KTChartsWidgetRUPTLKIT = {
    init: function () {
        ! function () {
            if ("undefined" != typeof am5) {
                var e = document.getElementById("KTChartsWidgetRUPTLKIT");
                if (e) {
                    var t, a = function () {
                        var a = [{
                            age: "0 to 5",
...
"undefined" != typeof module && (module.exports = KTChartsWidgetRUPTLKIT), KTUtil.onDOMContentLoaded((function () {
    KTChartsWidgetRUPTLKIT.init()
}));
